...
public class FakeBombInfo : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            if (strikes == 1 && !Strike1Obtained && NoStrike1)
            {
                NoStrike1 = false;
                Strike1Obtained = true;
                Time.fixedDeltaTime = Time.fixedDeltaTime / 1.5f;
            }
            else if (strikes == 2 && !Strike2Obtained && !NoStrike2)
            {
                NoStrike2 = false;
                Strike2Obtained = true;
                Time.fixedDeltaTime = Time.fixedDeltaTime / 1.5f;
            }
            timeLeft -= 1;
    ...
    bool Strike1Obtained;
    bool Strike2Obtained;
    bool NoStrike1 = true;
    bool NoStrike2 = true;
